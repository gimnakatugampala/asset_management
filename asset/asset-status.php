            ...
            <div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <button class="btn btn-danger bg-danger my-3" data-bs-toggle="modal" data-bs-target="#add-asset-status-modal"><i class="icon-plus mx-1"></i>  Add Status</button>
                                            ...
                                            <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>12/12/2021</td>
                                                        <td>
                                                            <button data-bs-toggle="modal" data-bs-target="#edit-asset-status-modal" type="button" class="btn btn-icon  btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button>
