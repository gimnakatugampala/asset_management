document.addEventListener("DOMContentLoaded", function () {
    const countrySelect = document.getElementById("cmbSubdep");

    // Function to load categories using AJAX
    function loadCountrylist() {
        const xhr = new XMLHttpRequest();
        xhr.open("GET", "../pages/list/subdeplist.php", true);
    ...
    function populatecountrySelect(categories) {
        ...
        categories.forEach(function (category) {
            ...
            option.textContent = category.subdepname;
            countrySelect.appendChild(option);
        });
    }

    const editcmbDepartment = document.getElementById("editcmbSubdep");
